...
export async function check({
  ...
  // and `acquirerMetaInsufficient`.
  const {
    authorized, excessResources, untrackedResources, acquirerMetaInsufficient
  } = checkResults;
  return {
    authorized, excessResources, untrackedResources, acquirerMetaInsufficient
  };
 ...
 *   `acquirerMetaInsufficient` will be set to `true`.
 */
...
async function _check({
  ...
  let acquirerMetaInsufficient = false;
  for(const restriction of restrictions) {
    ...
    acquirerMetaInsufficient = acquirerMetaInsufficient ||
      result.acquirerMetaInsufficient === true;
